  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Native <script> with dangerouslySetInnerHTML (NOT next/script): next/script queues
            inline content behind hydration; the metrika loader must run as soon as HTML
            parses so the page-view hit reaches Yandex before users navigate away. */}
        <script
        ...
        <noscript>
          <div>
            <img
              src="https://mc.yandex.ru/watch/111617876"
